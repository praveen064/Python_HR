...
IMO best way to print is making the following str() function in the class :

def __str__(self) :
    return '{0:.2f}{1:+.2f}i'.format(self.r,self.j)
	
and using the following line while printing :

print '\n'.join(map(str,[x+y, x-y, x*y, x/y, abs(x), abs(y)]))

To me it seems to be much simpler than the tedious str() function described in the editorial.