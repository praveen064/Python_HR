...
Average score = Sum of scores obtained in all subjects by a student/Total no.of subjects
...
Sol-0:
For this challange, zip all the subject scores and compute the averages.
